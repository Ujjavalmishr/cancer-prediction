...
# Set GPU memory growth to avoid TensorFlow memory allocation issues
...
IMG_SIZE = 128  # Adjusted image size
SPLIT = 0.2
EPOCHS = 10
BATCH_SIZE = 64
...
model.save('cancer_model.h5')  # replace filename with your chosen filename
